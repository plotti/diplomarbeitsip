...
Im vorgeschlagenen Partial-Mesh Ansatz verbindet sich der Teilnehmer nur mit Spielern die sich in seiner unmittelbaren Nähe befinden. Dies entspricht dem Proximitätskonzept, in dem nur Audioverbindungen nur mit Spielern aufgebaut werden, die sich mindestens in der Öffentlichen Zone befinden.
...
Der  Bandbreitenverbrauch wurde auch hier aus Sicht des Teilnehmers 1 gemessen. In dem Moment in dem Spieler 2 das Spiel betritt, wird mit ihm eine Audioverbindung aufgebaut, die zwischen 10-15kbps verbraucht. Betritt Spieler 3 dagegen das Spiel werden nur zusätzlich ca. 1-2kbps zur Aufrechterhaltung der Grundkonnektivität der RTP Verbindung benötigt. Würde sich Teilnehmer 3 nun auf Spieler 1 zubewegen, würde die Silence Suppression aufgehoben und auch ein normaler Audiostrom von 10-15kbs fließen. Spieler 4 und 5 verursachen keinen zusätzlichen Bandbreitenverbrauch, da sie sich außerhalb der öffentlichen Zone befinden.
