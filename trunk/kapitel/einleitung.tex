...
Lange Zeit war die Textkommunikation das einzige integrierte Kommunikationsmedium, das eine Verständigung in Mehrspieler-Computerspielen erlaubte. Da Texkommunikation aufgrund ihrer nicht ausreichenden Medienreichhaltigkeit (Mediarichness\footnote{Siehe Abschnitt \ref{mediarichness}}) \citep{rice92}, ein unzureichendes Kommunikationsmedium \cite{carter03}, \cite{pena04}, \cite{thon06} darstellte, um komplizierte Telekooperationsaufgaben, wie z.B. das taktische Befehligen von mehreren Spielern in Echtzeit zu lösen, wurde sie zunehmend von der Sprachkommunikation abgelöst. 
