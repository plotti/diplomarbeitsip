...
Der Einsatz solcher virtuellen Funksprechgeräte, deren Pendant im wirklichen Leben vor allem in Kampfsituationen genutzt wird, zeigte sich auch in virtuellen Welten von Vorteil. Dieser führte letztendlich zu einer so schnellen Adoption und Popularität von Sprachkommunikation in Computerspielen, dass viele Spielergruppen die Benutzung solcher Hilfsprogramme für ihre Mitglieder vorschreiben.
...
\begin{itemize}
	...
	\item \textbf{Kapitel 3} nutzt die Ergebnisse des theoretischen Ansatzes in Kapitel 2 und leitet aus den Untersuchungen bisheriger Lösungen sukzessive praktische Empfehlungen für eine Sprachkommunikationslösung ab.
