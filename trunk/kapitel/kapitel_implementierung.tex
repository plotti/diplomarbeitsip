...
\subsubsection{Pjsip}
Viele der existierenden SIP-Clientanwendungen und Protokollstapel kamen für den Prototypen deshalb nicht in Frage, weil sie in einer anderen Programmiersprache als C oder C++ geschrieben waren und so nicht in das 3D-Framework integriert werden konnten. Die Wahl fiel vor allem seiner guten Dokmentation und Platformunabhängigkeit auf \textit{PjSIP}. Im Gegensatz zu anderen Kandidaten, bietet es auch Dank der Kombination aus SIP-Signalisierung und der Existenz eines Audiostapels die besten Vorraussetzungen, um eine schnelle und Entwicklung zu gewährleisten. Es bietet außerdem eine Unterstüzung folgender in Kapitel 4 vorgestellten SIP-Funktionalitäten:
\begin{itemize}
