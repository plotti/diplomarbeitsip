...
Es gibt mehrere Sprachcodierungsverfahren, die bei Voice over IP verwendet werden können. Man unterscheidet zwischen Abtastwert-orientierten Codierungsverfahren, die zwar gute Sprachqualität garantieren aber Bitraten haben die größer als 16 Kbit/s sind und Segment-orientierten Codierungsverfahren die zwar geringe Bitraten haben aber dafür nur eine schlechte bis gute Sprachqualität bieten. 
...
\begin{figure}
\caption{Teilnehmer A schickt Teilnehmer B eine Nachricht. Beide sind Teil der gleichen Domäne sind, und benutzen den gleichen Proxy.}
	\centering
...
\begin{table}
\centering
\caption{Einige Sprachcodierungsverfahren und ihre PT-Nummern}
\label{pt-tabelle}
\begin{tabular}{lllr}
\toprule
PT-Nr. & Codierungsname & Codierungsart & Bitrate (kbit/s) \\
\midrule
...
Eine Übersicht üblicher Codecs ist in der Tabelle \ref{pt-tabelle} dargestellt. Den "`klassischen"' Audio Formaten sind feste Nummern zugeordnet. Weiter Typen befinden sich im dynamischen Bereich und können für jede Sitzung zu beliebigen Medienformaten vereinbart werden.
...
Nachdem sich beide Teilnehmer auf die unterstützte Formate geeinigt haben wurden, können beide Seite damit beginnen, die Mediendaten zu senden. Beide Seiten sollten jeweils das bevorzugte Format senden. Während einer Sitzung können die Parameter neu verhandelt werden, indem der gleiche Ablauf mit entsprechend modifizierten SDP-Beschreibungen durchgeführt wird. 
...
\begin{itemize}
	...
	\item Garantie der Reihenfolge von RTP-Paketen: RTP nummeriert die über\-tra\-genen Pakete mit Echtzeit\-medien, sodass ihre richtige Reihenfolge am Ziel wiederhergestellt werden kann, falls sie durch den Transport über das IP-Netz verädert wurde. 
...
\begin{itemize}
	...
	\item SSRC: Zur Identifikation der Quelle(Mikrofon, Kamera) dient der SSRC. Zwei verschiedene Quellen unterschiedliche SSRCs haben, um für den Empfänger unterscheidbar zu sein. 
...
Bei RR Paket werden Werte wie Jitter, Round-Trip-Delay (Hin und Zurück Verzögerung)  oder Paketverlust aus Sicht des Empfängers berechnet und abgeschätzt. 
