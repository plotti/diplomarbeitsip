...
\usepackage[font=small,labelfont=empty]{subfig}
...
\include{kapitel/abkuerzungen}  % beispiel eines handerstellten                        %verzeichnisses
...
\include{kapitel/kapitel_conclusion}
