...
//TODO \cite{schulzrinne05} -- Peer-to-Peer SIP Assumptions
...
Asterisk (Version 1.4.19) unterstützt Voice-over-IP mit unterschiedlichen Protokollen  darunter sowohl SIP als auch das H323 Protokoll und bietet alle Möglichkeiten einer Anbindung an das Telefonnetz. 
...
Bei diesem Szenarion können zwei verschiedene Fälle auftreten. Der einfache Fall liegt vor, wenn eine INVITE Nachricht von A eintritt und B bereits mit A verbunden ist. Dann kann er den zweiten Dialog einfach verwerfen, da ja bereits eine bestehende Verbindung existiert.
...
Durch die Möglichkeit SIP Server mit externen Gateways zu verbinden, wurde auch die Metapher des Festnetz-Telephons umgesetzt, dass dem Spieler tatsächlich erlaubt aus der virtuellen Welt in die reale Welt zu telefonieren. Hier wurde eine Telefonzelle auf dem Spielfeld plaziert. Befindet sich der Spieler in unmittelbarer Nähe zu dieser Zelle, findet ein Anruf an eine beliebige Telefonnumer statt. Dieses Proof of Concept wurde deshalb implementiert, um zu verdeutlichen, dass mit Hilfe eines standartisierten Protokolls auch solche Möglichkeiten offen stehen. 
