...
Aufgrund des hohen Bedarfs nach solchen Lösungen, bieten seit einigen Jahren Drittanbieter ergänzende Konferenzlösungen speziell für Spiele an. Diese sehen vor, dass dedizierte Server mit einer hohen Bandbreite und Rechenleistung von Spielergruppen eingekauft werden können, um darauf Audiokonferenzen abzuhalten. Hilfsprogramme auf Clientseite ermöglichen es dann parallel zur Spielesitzung in Kanälen auf solchen Servern eine Audioverständigung aufzubauen. Sprachkanäle solcher Programme sind wie ein Funksprechgerät konfiguriert: Normalerweise können alle Mitglieder eines Teams die auf dem gleichen Kanal verbunden sind, den Sprecher hören. 
...
\begin{itemize}
	...
	\item Spieler sind oft auf den Einsatz von kostenpflichtiger Konferenzservern angewiesen, da das Abmischen des Audiostroms zentral vorgenommen wird, was mit einer hohen Bandbreiten- und Kapazitätsauslastung verbunden ist. Die meisten Spieler verfügen selbst kaum über die Bandbreiten- und Rechenkapazitäten, um solche Server privat zu betreiben. 	
	\item Benutzen zu viele Spieler einen gemeinsamen Sprachkanal, ist dieser aufgrund der gegenseitigen Interferenzen schnell überlastet. Sind zu viele Stimmen auf einmal zu hören, sind die Teilnehmer nicht mehr in der Lage sich gegenseitig zu verstehen. 
\end{itemize}

\section{Marktrelevanz}

Es liegt nahe zwei große Bereiche, die in den letzten Jahren einen starken Wachstum
gezeigt haben, miteinander zu verknüpfen, um für die bestehenden Probleme neue Ansätze zu finden.
...
Ein solches Szenario ermöglicht sowohl eine interpersonnelle Kommunikation zwischen Mitspielern, indem sich nur 2 Spieler in Hörnähe befinden, als auch eine Massenkommunikation, bei der mehrere Spieler in gemeinsamer Nähe miteinander sprechen können.
...
\begin{itemize}
	...
	\item \textbf{Kapitel 3} nutzt die Ergebnisse des theoretischen Ansatzes in Kapitel 2 und leitet aus den Untersuchung bisheriger Lösungen sukzessive praktische Empfehlungen für eine Sprachkommunikationslösung ab.
	...
	\item \textbf{Kapitel 9} stellt anhand ausgewählter Messergenisse vor, wie sich das Resultat der Umsetzung quantitativ erfassen lässt. 
	\item \textbf{Kapitel 10} fasst die Aufgaben, die in dieser Arbeit geleistet wurden, noch einmal zusammen und geht auf noch offene Fragen und Verbesserungsmöglichkeiten ein.
\end{itemize}
