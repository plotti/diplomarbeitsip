...
\textit{Kapitel 2} liefert Grundlagen der Kommunikation, die genutzt werden, um in \textit{Kapitel 3} aus den Untersuchungen bisheriger Sprachkommunikationslösungen sukzessive praktische Empfehlungen für die in der Arbeit vorgestellte Lösung abzuleiten. \textit{Kapitel 4} beschäftigt sich mit den technischen Grundlagen einer Implementierung und erläutert wichtige Bestandteile des gewählten Protokolls. \textit {Kapitel 5} stellt relevante Arbeiten im Bereich der Sprachkommunikation vor und zeigt deren Vor- und Nachteile.	Eine strukturierte Analyse möglicher Architekturen für eine Sprachübertragung wird in \textit{Kapitel 6} vorgenommen und eine Empfehlung für die Implementierung getroffen. \textit{Kapitel 7} befasst sich mit der Implementierung Prototyps auf Basis eines hybriden SIP Multi-Unicast-Ansatzes und präsentiert ausgewählte Details und Probleme bei der Umsetzung.	\textit{Kapitel 8} liefert eine kurze Übersicht bestehender Architekturen für Netzwerkspiele und zeigt wie das gewählte SIP-Protokoll zusätzlich auch als Netzwerkschicht eingesetzt werden kann.  Messergenisse zeigen in \textit{Kapitel 9}, wie das Resultat der Umsetzung quantitativ erfasst wurde. \textit{Kapitel 10} fasst die Aufgaben, die in dieser Arbeit geleistet wurden, noch einmal zusammen und geht auf noch offene Fragen und Verbesserungs\-möglichkeiten ein.
