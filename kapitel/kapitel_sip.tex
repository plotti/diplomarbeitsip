...
Der Message Body enthält die Besonderheiten der RTP-Session, die durch das SDP (Session Description Protocol) festgelegt wird. Der Message Body setzt sich aus der Spezifikation der RTP-Session, der Zeitbeschreibung und der Medienbeschreibung zusammen. 
...
\begin{itemize}
	...
	\item a: Hier wird angegeben welches Format des Mediums empfangen werden kann. 
\end{itemize}
...
Ausgewählte erweiterte Request-Typen:
\begin{itemize}
	...
	\item SUBSCRIBE und NOTIFY: SIP kann verwendet werden, um bestimmt Ereignisse zu übermitteln. Hierfür sind die Nachrichten SUBSCRIBE und NOTIFY eingeführt worden. So kann z.B. die Anwesenheit eines Teilnehmers von weiteren Teilnehmern mit einer SUBSCRIBE Nachricht abonniert werden. Geht dieser Teilnehmer online so benachrichtigt er alle anderen Teilnehmer mit einer NOTIFY Nachricht die seine Anwesenheit abonnieren. 
\end{itemize}
